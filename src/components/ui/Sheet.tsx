      ...
      {open ? (
        <div className="fixed inset-0 z-50">
          ...
          <motion.div
            ...
            aria-modal="true"
            aria-label={title}
            className="absolute inset-x-0 bottom-0 max-h-[88dvh] overflow-hidden rounded-t-[1.75rem] bg-surface-raised"
            initial={{ y: '100%' }}
            animate={{ y: 0 }}
            exit={{ y: '100%' }}
          ...
          >
            ...
            <div className="overflow-y-auto overscroll-contain px-5 pt-3 pb-safe">
